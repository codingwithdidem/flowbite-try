  ...
  return (
    <div>
      ...
      <main>
            ...
            <Tabs.Group aria-label="Default tabs" style="default">
              <Tabs.Item active={true} title="Profile">
                <div className="flex items-center space-x-4">
                  ...
                  <button className="px-6 py-2 bg-fuchsia-500 rounded-md text-white hover:bg-fuchsia-600 transition-colors duration-300 ease-in-out">
                    Custom btn
                  </button>
                </div>
              </Tabs.Item>
        ...
        <section className="max-w-5xl mx-auto py-5 text-center">
        ...
        <section id="newsletter">
          <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="relative -mx-4 overflow-hidden bg-indigo-50 py-20 px-4 sm:-mx-6 sm:px-6 md:mx-0 md:rounded-5xl md:px-16 xl:px-24 xl:py-36">
              <img
                alt=""
                src="https://keynote.tailwindui.com/_next/static/media/background-newsletter.488a0204.jpg"
                width="919"
                height="1351"
                decoding="async"
                data-nimg="1"
